 ...
 */
export declare const useRepositoryActions: (setView: (view: TBrowserView) => void, setExpandedRepo: React.Dispatch<React.SetStateAction<string | null>>, setSelectedRepo: (repo: string | null) => void, setSelectedRelease: (release: IRelease | "latest" | null) => void, setSelectedReleaseTag: (tag: string | null) => void, setSearchQuery: (query: string) => void, fetchReleasesForRepo: (repoFullName: string) => Promise<void>) => TUseRepositoryActionsReturn;
